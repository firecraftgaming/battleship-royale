defmodule Waffle.Message.Call do
    alias Waffle.Message.Cast
    ...
    defmacro __using__(opts) do
      ...
      quote do
        ...
        @after_compile Waffle.Message.Call
      end
    end
  
    alias Ecto.Changeset
    alias Waffle.SocketHandler
    ...
    @callback changeset(struct | nil, Waffle.json()) :: Ecto.Changeset.t()
